...
const BookingsPage = async () => {
  ...
  if (!bookings || bookings.length === 0) return <EmptyList />;
  ...
  return (
    <section className='mt-16'>
      ...
      <Table>
        <TableCaption>List of your recent bookings.</TableCaption>
        <TableHeader>
          <TableRow>
        ...
        <TableBody>
          {bookings.map((booking) => {
            const { id, orderTotal, totalNights, checkIn, checkOut, property } =
              booking;
